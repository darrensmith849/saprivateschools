...
$header_classes = [
	'c27-main-header',
	'header',
	"header-style-{$data['style']}",
	"header-width-{$data['width']}",
	"header-{$data['skin']}-skin",
	"header-scroll-{$data['scroll_skin']}-skin",
	'header-scroll-hide'
];
...
$membership_status = sspi_membership_status();
...
<style>
    ...
    header.free_member:not(.header-scroll) {
    ...
    .sspi_name .user_membership_level {
	    color: var(--accent);
    }

    header.free_member #menu-main-menu .premium-feature a::after {
	    content: ' 🔒';
    }
</style>

<?php if ( $membership_status == 'free_member' ) { ?>
    <div class="header_top_bar">
        <div class="header_top_bar_content">
            You are currently on the <a href="#">Free Membership.</a>
            and will not be able to gain access to certain features.
            You can upgrade <a href="#">here</a>.
        </div>
    </div>
<?php } ?>
<header class="<?php echo esc_attr( join( ' ', $header_classes ) ) ?> <?php echo $membership_status; ?>">
    <div class="header-skin"></div>
    <div class="header-container">
        <div class="header-top container-fluid">
            <div class="header-left">
                <div class="mobile-menu">
                    <a aria-label="<?php echo esc_attr( _e( 'Mobile menu icon', 'my-listing' ) ) ?>" href="#main-menu">
                ...
                <div class="logo">
					<?php if ( $data['logo'] ): ?>
						<?php if ( $data['scroll_logo'] ): ?>
                            <a aria-label="<?php echo esc_attr( _ex( 'Site logo', 'Site logo - SR', 'my-listing' ) ) ?>"
                               href="<?php echo esc_url( home_url( '/' ) ) ?>" class="scroll-logo">
                        ...
                        <a aria-label="<?php echo esc_attr( _ex( 'Site logo', 'Site logo - SR', 'my-listing' ) ) ?>"
                           href="<?php echo esc_url( home_url( '/' ) ) ?>" class="static-logo">
                            <img src="<?php echo esc_url( $data['logo'] ) ?>"
                                 alt="<?php echo esc_attr( c27()->get_site_logo_alt_text() ) ?>">
                        </a>
					<?php else: ?>
                        <a aria-label="<?php echo esc_attr( _ex( 'Site logo', 'Site logo - SR', 'my-listing' ) ) ?>"
                           href="<?php echo esc_url( home_url( '/' ) ) ?>" class="header-logo-text">
                ...
                <div class="i-nav">
                    <div class="mobile-nav-head">
                        <div class="mnh-close-icon">
                            <a aria-label="<?php echo esc_attr( _e( 'Close mobile menu', 'my-listing' ) ) ?>"
						...
						<?php if ( is_user_logged_in() ): $current_user = wp_get_current_user(); ?>
                            <div class="user-profile-dropdown">
                                <a class="user-profile-name" href="#">
                                    ...
                                    <div class="sspi_name">
                                        <div class="user_display_name"><?php echo esc_attr( $current_user->display_name ) ?>
                                            <br></div>
                                        <div class="user_membership_level">
            ...
            <div class="header-right">
                    ...
                    <div class="user-area">
						...
						<?php if ( c27()->get_setting( 'messages_enabled', true ) !== false ): ?>
                            <div class="messaging-center inbox-header-icon">
                                <a href="#" id="messages-modal-toggle" class="icon-btn" data-toggle="modal"
                                   data-target="#ml-messages-modal">
                                    <i class="mi forum"></i>
				...
				<?php else: ?>
                    ...
                    <div class="mob-sign-in">
                        <a aria-label="<?php echo esc_attr( _e( 'Mobile sign in button', 'my-listing' ) ) ?>"
                           href="<?php echo esc_url( \MyListing\get_login_url() ) ?>"><i class="mi person"></i></a>
                    </div>
				...
				<?php if ( $data['show_search_form'] ): ?>
                    <div class="search-trigger" data-toggle="modal" data-target="#quicksearch-mobile-modal">
                        <a aria-label="<?php echo esc_attr( _e( 'Header mobile search trigger', 'my-listing' ) ) ?>"
                           href="#"><i class="mi search"></i></a>
                    </div>
				<?php endif ?>
            </div>
        </div>
...
<?php echo do_shortcode('[wc_schools_sidebar]'); ?>
