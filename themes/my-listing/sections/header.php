			...
			<div class="logo">
				<?php if ( $data['logo'] ): ?>
					<?php if ( $data['scroll_logo'] ): ?>
						<a aria-label="<?php echo esc_attr( _ex( 'Site logo', 'Site logo - SR', 'my-listing' ) ) ?>" href="<?php echo esc_url( home_url('/') ) ?>" class="scroll-logo">
							<img src="<?php echo esc_url( $data['scroll_logo'] ) ?>"
								alt="<?php echo esc_attr( c27()->get_site_logo_alt_text() ) ?>">
						</a>
					<?php endif ?>

					<a aria-label="<?php echo esc_attr( _ex( 'Site logo', 'Site logo - SR', 'my-listing' ) ) ?>" href="<?php echo esc_url( home_url('/') ) ?>" class="static-logo">
						<img src="<?php echo esc_url( $data['logo'] ) ?>"
							alt="<?php echo esc_attr( c27()->get_site_logo_alt_text() ) ?>">
					</a>
				<?php else: ?>
					<a aria-label="<?php echo esc_attr( _ex( 'Site logo', 'Site logo - SR', 'my-listing' ) ) ?>" href="<?php echo esc_url( home_url('/') ) ?>" class="header-logo-text">
			...
			<div class="i-nav">
				<div class="mobile-nav-head">
					<div class="mnh-close-icon">
						<a aria-label="<?php echo esc_attr( _e( 'Close mobile menu', 'my-listing' ) ) ?>" href="#close-main-menu">
							<i class="mi close"></i>
						</a>
					</div>
			...
			<div class="header-right">
				...
				<?php else: ?>
					...
					<div class="mob-sign-in">
						<a aria-label="<?php echo esc_attr( _e( 'Mobile sign in button', 'my-listing' ) ) ?>" href="<?php echo esc_url( \MyListing\get_login_url() ) ?>"><i class="mi person"></i></a>
					</div>
				...
				<?php if ( $data['show_search_form'] ): ?>
					<div class="search-trigger" data-toggle="modal" data-target="#quicksearch-mobile-modal">
						<a aria-label="<?php echo esc_attr( _e( 'Header mobile search trigger', 'my-listing' ) ) ?>" href="#"><i class="mi search"></i></a>
					</div>
				<?php endif ?>
			</div>
		</div>
