...
?>
<div v-cloak id="c27-explore-listings" :class="['mobile-tab-'+state.mobileTab]" class="cts-explore explore-classic <?php echo $data['types_template'] === 'dropdown' ? 'explore-types-dropdown' : 'explore-types-topbar' ?> <?php echo esc_attr( $data['finder_columns'] ) ?>">
