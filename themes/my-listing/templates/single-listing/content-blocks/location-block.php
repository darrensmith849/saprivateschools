...
// use the listing logo for the marker image, with fallback to default marker, if none available show marker jpg
$marker_image = $listing->get_marker( 'thumbnail' ) ?: c27()->image( 'marker.jpg' );
