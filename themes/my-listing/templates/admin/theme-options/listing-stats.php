	...
	<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ) ?>" method="POST">
		...
		<div style="max-width:700px;">
			<div class="form-group mb20 dibvt switch-setting" style="width:270px;">
				<h4 class="m-heading mb5">Enable Published Listings</h4>
				<p class="mt0 mb10">Displays a box with the number of published listings.</p>
				<label class="form-switch">
					<input type="checkbox" name="show_published_listings" value="1" <?php checked( true, (bool) $config['show_published_listings'] ) ?>>
					<span class="switch-slider"></span>
				</label>
			</div>

			<div class="form-group mb20 dibvt switch-setting" style="width:270px;">
				<h4 class="m-heading mb5">Enable Pending Listings</h4>
				<p class="mt0 mb10">Displays a box with the number of pending listings.</p>
				<label class="form-switch">
					<input type="checkbox" name="show_pending_listings" value="1" <?php checked( true, (bool) $config['show_pending_listings'] ) ?>>
					<span class="switch-slider"></span>
				</label>
			</div>

			<div class="form-group mb20 dibvt switch-setting" style="width:270px;">
				<h4 class="m-heading mb5">Enable Active Promotions</h4>
				<p class="mt0 mb10">Displays a box with the number of active promotions.</p>
				<label class="form-switch">
					<input type="checkbox" name="show_active_promotions" value="1" <?php checked( true, (bool) $config['show_active_promotions'] ) ?>>
					<span class="switch-slider"></span>
				</label>
			</div>

			<div class="form-group mb20 dibvt switch-setting" style="width:270px;">
				<h4 class="m-heading mb5">Enable Visits this week</h4>
				<p class="mt0 mb10">Displays a box with the number of visits this week.</p>
				<label class="form-switch">
					<input type="checkbox" name="show_visits_this_week" value="1" <?php checked( true, (bool) $config['show_visits_this_week'] ) ?>>
					<span class="switch-slider"></span>
				</label>
			</div>
		...
		<h3 class="m-heading mb30 mt40">My Listings page</h3>
		<div style="max-width:700px;">
			<div class="form-group mb20 dibvt switch-setting" style="width:270px;">
				<h4 class="m-heading mb5">Enable Published</h4>
				<p class="mt0 mb10">Displays a box with the number of published listings.</p>
				<label class="form-switch">
					<input type="checkbox" name="show_mylistings_published" value="1" <?php checked( true, (bool) $config['show_mylistings_published'] ) ?>>
					<span class="switch-slider"></span>
				</label>
			</div>

			<div class="form-group mb20 dibvt switch-setting" style="width:270px;">
				<h4 class="m-heading mb5">Enable Pending Approval</h4>
				<p class="mt0 mb10">Displays a box with the number of listings pending approval.</p>
				<label class="form-switch">
					<input type="checkbox" name="show_pending_approval" value="1" <?php checked( true, (bool) $config['show_pending_approval'] ) ?>>
					<span class="switch-slider"></span>
				</label>
			</div>

			<div class="form-group mb20 dibvt switch-setting" style="width:270px;">
				<h4 class="m-heading mb5">Enable Pending Payment</h4>
				<p class="mt0 mb10">Displays a box with the number of listings pending payment.</p>
				<label class="form-switch">
					<input type="checkbox" name="show_pending_payment" value="1" <?php checked( true, (bool) $config['show_pending_payment'] ) ?>>
					<span class="switch-slider"></span>
				</label>
			</div>

			<div class="form-group mb20 dibvt switch-setting" style="width:270px;">
				<h4 class="m-heading mb5">Enable Expired</h4>
				<p class="mt0 mb10">Displays a box with the number of expired listings.</p>
				<label class="form-switch">
					<input type="checkbox" name="show_mylistings_expired" value="1" <?php checked( true, (bool) $config['show_mylistings_expired'] ) ?>>
					<span class="switch-slider"></span>
				</label>
			</div>
		</div>
