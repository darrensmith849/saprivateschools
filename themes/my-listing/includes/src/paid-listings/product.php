...
class Product extends \WC_Product_Simple {
	...
	/**
	 * Is this package used in add listing process
	 *
	 * @since 2.10.5
	 */
	public function hide_in_add_listing() {
		return $this->get_product_meta( 'hide_in_add_listing' ) === 'yes';
	}

	/**
	 * Is this package claimable
	 *
	 * @since 2.10.5
	 */
	public function is_claimable() {
		return $this->get_product_meta( 'is_claimable' ) === 'yes';
	}
}
