...
class Listing_Stats {
	...
	private $settings = [
		...
		// stat boxes
		'show_published_listings' => true,
		'show_pending_listings' => true,
		'show_active_promotions' => true,
		'show_visits_this_week' => true,
		'show_mylistings_published' => true,
		'show_pending_approval' => true,
		'show_pending_payment' => true,
		'show_mylistings_expired' => true,
		'show_referrers' => true,
		'show_browsers' => true,
		'show_platforms' => true,
		'show_countries' => true,
	...
	public function save_settings() {
    	...
    	$config['show_published_listings'] = ! empty( $_POST['show_published_listings'] ) ? true : false;
    	$config['show_pending_listings'] = ! empty( $_POST['show_pending_listings'] ) ? true : false;
    	$config['show_active_promotions'] = ! empty( $_POST['show_active_promotions'] ) ? true : false;
    	$config['show_visits_this_week'] = ! empty( $_POST['show_visits_this_week'] ) ? true : false;
    	$config['show_mylistings_published'] = ! empty( $_POST['show_mylistings_published'] ) ? true : false;
    	$config['show_pending_approval'] = ! empty( $_POST['show_pending_approval'] ) ? true : false;
    	$config['show_pending_payment'] = ! empty( $_POST['show_pending_payment'] ) ? true : false;
    	$config['show_mylistings_expired'] = ! empty( $_POST['show_mylistings_expired'] ) ? true : false;
    ...
    public function maybe_migrate_options() {
    	...
    	$config['show_published_listings'] = get_option( 'options_stats_published_listings_enabled' ) === '0' ? false : true;
    	$config['show_pending_listings'] = get_option( 'options_stats_pending_listings_enabled' ) === '0' ? false : true;
    	$config['show_active_promotions'] = get_option( 'options_stats_active_promotions_enabled' ) === '0' ? false : true;
    	$config['show_visits_this_week'] = get_option( 'options_stats_visits_this_week_enabled' ) === '0' ? false : true;
    	$config['show_mylistings_published'] = get_option( 'options_stats_mylistings_published' ) === '0' ? false : true;
    	$config['show_pending_approval'] = get_option( 'options_stats_pending_approval' ) === '0' ? false : true;
    	$config['show_pending_payment'] = get_option( 'options_stats_pending_payment' ) === '0' ? false : true;
    	$config['show_mylistings_expired'] = get_option( 'options_stats_mylistings_expired' ) === '0' ? false : true;
    	...
    	$cleanup = [
    		...
    		'stats_published_listings_enabled',
    		'stats_pending_listings_enabled',
    		'stats_active_promotions_enabled',
    		'stats_visits_this_week_enabled',
    		'stats_mylistings_published',
    		'stats_pending_approval',
    		'stats_pending_payment',
    		'stats_mylistings_expired',
