...
class Listing_Feed extends \Elementor\Widget_Base {
	...
	protected function render( $instance = [] ) {
		...
		$navMode = $this->get_settings('owl_nav');
		$autoplay = $this->get_settings('owl_autoplay');
		$speed = $this->get_settings('owl_speed');
		$loop = $this->get_settings('owl_loop');
		$owlD = $this->get_settings('owl_items_desktop');
		$owlT = $this->get_settings('owl_items_tablet');
		$owlM = $this->get_settings('owl_items_mobile');
	...
	protected function get_listings_query() {
		...
		if ( $listing_types = $this->get_settings('select_listing_types') ) {
