    ...
    public static function button( $values ){
        ...
        $btn_settings = $opts->table(array(
            ...
            array( self::pro_link( 'btn-reveal-time', 'Reveal button in' ), $opts->field( 'text', array(
                ...
                'type' => 'number',
                'class' => 'ufw_pro_feature',
                'helper' => 'With this feature, the button will be hidden first and it will be displayed after a specific time<br/>Note: This feature is available as a part of the <a href="https://www.aakashweb.com/wordpress-plugins/ultimate-floating-widgets/?utm_source=admin&utm_medium=btn-reveal-time&utm_campaign=ufw-pro#pro">PRO version</a>',
                'tooltip' => 'With this feature, the button will be hidden first and it will be displayed after a specific time'
            ))),
